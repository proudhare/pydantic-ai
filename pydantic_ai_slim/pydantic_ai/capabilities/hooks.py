...
async def _call_func(func: Callable[..., Any], *args: Any, **kwargs: Any) -> Any:
    """Call a function, awaiting async functions and handling sync functions inline.

    Sync functions run inline on the event loop thread to preserve contextvar propagation.
    This matches the documented pattern for cross-capability state sharing via ContextVar.
    """
