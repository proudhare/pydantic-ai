    ...
    async def _completions_create(
        ...
        with _map_api_errors(self.model_name):
            response = await self.client.chat.complete_async(
                ...
                presence_penalty=model_settings.get('presence_penalty', UNSET),
                frequency_penalty=model_settings.get('frequency_penalty', UNSET),
                stop=model_settings.get('stop_sequences', UNSET),
